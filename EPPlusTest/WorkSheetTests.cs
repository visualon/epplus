    ...
    public class WorkSheetTest : TestBase
    {
        ...
        public void ReadWorkSheet()
        {
            ...
            using (ExcelPackage pck = new ExcelPackage(instream))
            {
                ...
                {
                    Assert.AreEqual(ws.Cells["T20"].GetValue<string>(), 0.396180555555554d.ToString(CultureInfo.CurrentCulture));
                    Assert.AreEqual(ws.Cells["T20"].GetValue<double>(), 0.396180555555554d);
                    Assert.AreEqual(ws.Cells["T20"].GetValue<double?>(), 0.396180555555554d);
                }
                else
                {
